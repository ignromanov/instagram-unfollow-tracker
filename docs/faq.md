...
Yes! See [docs/roadmap.md](roadmap.md) for planned features including CSV export, PWA support, and multi-language UI.
...
Updates are released regularly based on community feedback and development progress. Check the [roadmap](roadmap.md) for upcoming features.
